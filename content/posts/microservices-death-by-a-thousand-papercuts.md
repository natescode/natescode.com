...
The main difficulty in my limited experience over the 3 years I've spent with M.S. is that defining barriers is a deceivingly difficult problem. Which is a theme of software that
...
M.S. can get REALLY chatty. Imagine making a PBJ sandwhich BUT instead of ONE human, you have three. Human **M** can move items. Human **S** can SEE (others are blindfolded) and Human **D** can do thing with their hands. The amount of communication would be insane.

Especially at the database level. M.S kills me when in my head I just need to query 2-3 table and then realize instead of 3 tables, it is 3 databases, 3 services and then need to manually join the
data in memory with code.
